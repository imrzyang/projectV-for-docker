...
sed -i "s#UUID#$UUID#g;s#TROJAN_PASSWORD#$TROJAN_PASSWORD#g;s#VMESS_WSPATH#$VMESS_WSPATH#g;s#VLESS_WSPATH#$VLESS_WSPATH#g;s#TROJAN_WSPATH#$TROJAN_WSPATH#g" /etc/v2ray/config.json
